...
class EvaluationServiceClient(metaclass=EvaluationServiceClientMeta):
    ...
    @staticmethod
    def agent_path(project: str,location: str,app: str,agent: str,) -> str:
        """Returns a fully-qualified agent string."""
        return "projects/{project}/locations/{location}/apps/{app}/agents/{agent}".format(project=project, location=location, app=app, agent=agent, )

    @staticmethod
    def parse_agent_path(path: str) -> Dict[str,str]:
        """Parses a agent path into its component segments."""
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/apps/(?P<app>.+?)/agents/(?P<agent>.+?)$", path)
        return m.groupdict() if m else {}

    @staticmethod
    def app_path(project: str,location: str,app: str,) -> str:
        """Returns a fully-qualified app string."""
        return "projects/{project}/locations/{location}/apps/{app}".format(project=project, location=location, app=app, )

    @staticmethod
    def parse_app_path(path: str) -> Dict[str,str]:
        """Parses a app path into its component segments."""
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/apps/(?P<app>.+?)$", path)
        return m.groupdict() if m else {}

    @staticmethod
    def app_version_path(project: str,location: str,app: str,version: str,) -> str:
        """Returns a fully-qualified app_version string."""
        return "projects/{project}/locations/{location}/apps/{app}/versions/{version}".format(project=project, location=location, app=app, version=version, )

    @staticmethod
    def parse_app_version_path(path: str) -> Dict[str,str]:
        """Parses a app_version path into its component segments."""
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/apps/(?P<app>.+?)/versions/(?P<version>.+?)$", path)
        return m.groupdict() if m else {}

    @staticmethod
    def changelog_path(project: str,location: str,app: str,changelog: str,) -> str:
        """Returns a fully-qualified changelog string."""
        return "projects/{project}/locations/{location}/apps/{app}/changelogs/{changelog}".format(project=project, location=location, app=app, changelog=changelog, )

    @staticmethod
    def parse_changelog_path(path: str) -> Dict[str,str]:
        """Parses a changelog path into its component segments."""
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/apps/(?P<app>.+?)/changelogs/(?P<changelog>.+?)$", path)
        return m.groupdict() if m else {}

    @staticmethod
    def conversation_path(project: str,location: str,app: str,conversation: str,) -> str:
        """Returns a fully-qualified conversation string."""
        return "projects/{project}/locations/{location}/apps/{app}/conversations/{conversation}".format(project=project, location=location, app=app, conversation=conversation, )

    @staticmethod
    def parse_conversation_path(path: str) -> Dict[str,str]:
        """Parses a conversation path into its component segments."""
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/apps/(?P<app>.+?)/conversations/(?P<conversation>.+?)$", path)
        return m.groupdict() if m else {}

    @staticmethod
    def evaluation_path(project: str,location: str,app: str,evaluation: str,) -> str:
        """Returns a fully-qualified evaluation string."""
        return "projects/{project}/locations/{location}/apps/{app}/evaluations/{evaluation}".format(project=project, location=location, app=app, evaluation=evaluation, )

    @staticmethod
    def parse_evaluation_path(path: str) -> Dict[str,str]:
        """Parses a evaluation path into its component segments."""
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/apps/(?P<app>.+?)/evaluations/(?P<evaluation>.+?)$", path)
        return m.groupdict() if m else {}

    @staticmethod
    def evaluation_dataset_path(project: str,location: str,app: str,evaluation_dataset: str,) -> str:
        """Returns a fully-qualified evaluation_dataset string."""
        return "projects/{project}/locations/{location}/apps/{app}/evaluationDatasets/{evaluation_dataset}".format(project=project, location=location, app=app, evaluation_dataset=evaluation_dataset, )

    @staticmethod
    def parse_evaluation_dataset_path(path: str) -> Dict[str,str]:
        """Parses a evaluation_dataset path into its component segments."""
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/apps/(?P<app>.+?)/evaluationDatasets/(?P<evaluation_dataset>.+?)$", path)
        return m.groupdict() if m else {}

    @staticmethod
    def evaluation_expectation_path(project: str,location: str,app: str,evaluation_expectation: str,) -> str:
        """Returns a fully-qualified evaluation_expectation string."""
        return "projects/{project}/locations/{location}/apps/{app}/evaluationExpectations/{evaluation_expectation}".format(project=project, location=location, app=app, evaluation_expectation=evaluation_expectation, )
    ...
    def parse_evaluation_expectation_path(path: str) -> Dict[str,str]:
        ...
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/apps/(?P<app>.+?)/evaluationExpectations/(?P<evaluation_expectation>.+?)$", path)
        return m.groupdict() if m else {}

    @staticmethod
    def evaluation_result_path(project: str,location: str,app: str,evaluation: str,evaluation_result: str,) -> str:
        """Returns a fully-qualified evaluation_result string."""
        return "projects/{project}/locations/{location}/apps/{app}/evaluations/{evaluation}/results/{evaluation_result}".format(project=project, location=location, app=app, evaluation=evaluation, evaluation_result=evaluation_result, )

    @staticmethod
    def parse_evaluation_result_path(path: str) -> Dict[str,str]:
        """Parses a evaluation_result path into its component segments."""
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/apps/(?P<app>.+?)/evaluations/(?P<evaluation>.+?)/results/(?P<evaluation_result>.+?)$", path)
        return m.groupdict() if m else {}

    @staticmethod
    def evaluation_run_path(project: str,location: str,app: str,evaluation_run: str,) -> str:
        """Returns a fully-qualified evaluation_run string."""
        return "projects/{project}/locations/{location}/apps/{app}/evaluationRuns/{evaluation_run}".format(project=project, location=location, app=app, evaluation_run=evaluation_run, )

    @staticmethod
    def parse_evaluation_run_path(path: str) -> Dict[str,str]:
        """Parses a evaluation_run path into its component segments."""
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/apps/(?P<app>.+?)/evaluationRuns/(?P<evaluation_run>.+?)$", path)
        return m.groupdict() if m else {}

    @staticmethod
    def scheduled_evaluation_run_path(project: str,location: str,app: str,scheduled_evaluation_run: str,) -> str:
        """Returns a fully-qualified scheduled_evaluation_run string."""
        return "projects/{project}/locations/{location}/apps/{app}/scheduledEvaluationRuns/{scheduled_evaluation_run}".format(project=project, location=location, app=app, scheduled_evaluation_run=scheduled_evaluation_run, )
    ...
    def parse_scheduled_evaluation_run_path(path: str) -> Dict[str,str]:
        ...
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/apps/(?P<app>.+?)/scheduledEvaluationRuns/(?P<scheduled_evaluation_run>.+?)$", path)
        return m.groupdict() if m else {}

    @staticmethod
    def tool_path(project: str,location: str,app: str,tool: str,) -> str:
        """Returns a fully-qualified tool string."""
        return "projects/{project}/locations/{location}/apps/{app}/tools/{tool}".format(project=project, location=location, app=app, tool=tool, )

    @staticmethod
    def parse_tool_path(path: str) -> Dict[str,str]:
        """Parses a tool path into its component segments."""
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/apps/(?P<app>.+?)/tools/(?P<tool>.+?)$", path)
        return m.groupdict() if m else {}

    @staticmethod
    def toolset_path(project: str,location: str,app: str,toolset: str,) -> str:
        """Returns a fully-qualified toolset string."""
        return "projects/{project}/locations/{location}/apps/{app}/toolsets/{toolset}".format(project=project, location=location, app=app, toolset=toolset, )

    @staticmethod
    def parse_toolset_path(path: str) -> Dict[str,str]:
        """Parses a toolset path into its component segments."""
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/apps/(?P<app>.+?)/toolsets/(?P<toolset>.+?)$", path)
        return m.groupdict() if m else {}
    ...
    def generate_evaluation(self,
            request: Optional[Union[evaluation_service.GenerateEvaluationRequest, dict]] = None,
            *,
    ...
    def import_evaluations(self,
            request: Optional[Union[evaluation_service.ImportEvaluationsRequest, dict]] = None,
            *,
            parent: Optional[str] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
    ...
    def create_evaluation_dataset(self,
            request: Optional[Union[evaluation_service.CreateEvaluationDatasetRequest, dict]] = None,
            *,
            parent: Optional[str] = None,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.create_evaluation_dataset]
    ...
    def update_evaluation(self,
            request: Optional[Union[evaluation_service.UpdateEvaluationRequest, dict]] = None,
            *,
            evaluation: Optional[gcc_evaluation.Evaluation] = None,
    ...
    def update_evaluation_dataset(self,
            request: Optional[Union[evaluation_service.UpdateEvaluationDatasetRequest, dict]] = None,
            *,
            evaluation_dataset: Optional[evaluation.EvaluationDataset] = None,
            update_mask: Optional[field_mask_pb2.FieldMask] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.update_evaluation_dataset]
    ...
    def delete_evaluation(self,
            request: Optional[Union[evaluation_service.DeleteEvaluationRequest, dict]] = None,
            *,
    ...
    def delete_evaluation_result(self,
            request: Optional[Union[evaluation_service.DeleteEvaluationResultRequest, dict]] = None,
            *,
            name: Optional[str] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
    ...
    def delete_evaluation_dataset(self,
            request: Optional[Union[evaluation_service.DeleteEvaluationDatasetRequest, dict]] = None,
            *,
            name: Optional[str] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.delete_evaluation_dataset]
    ...
    def delete_evaluation_run(self,
            request: Optional[Union[evaluation_service.DeleteEvaluationRunRequest, dict]] = None,
            *,
            name: Optional[str] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
    ...
    def get_evaluation_result(self,
            request: Optional[Union[evaluation_service.GetEvaluationResultRequest, dict]] = None,
            *,
            name: Optional[str] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
    ...
    def get_evaluation_dataset(self,
            request: Optional[Union[evaluation_service.GetEvaluationDatasetRequest, dict]] = None,
            *,
            name: Optional[str] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
    ...
    def get_evaluation_run(self,
            request: Optional[Union[evaluation_service.GetEvaluationRunRequest, dict]] = None,
            *,
            name: Optional[str] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
    ...
    def list_evaluation_datasets(self,
            request: Optional[Union[evaluation_service.ListEvaluationDatasetsRequest, dict]] = None,
            *,
            parent: Optional[str] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
    ...
    def list_evaluation_runs(self,
            request: Optional[Union[evaluation_service.ListEvaluationRunsRequest, dict]] = None,
            *,
            parent: Optional[str] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
    ...
    def list_evaluation_expectations(self,
            request: Optional[Union[evaluation_service.ListEvaluationExpectationsRequest, dict]] = None,
            *,
            parent: Optional[str] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, evaluation_service.ListEvaluationExpectationsRequest):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.list_evaluation_expectations]
    ...
    def get_evaluation_expectation(self,
            request: Optional[Union[evaluation_service.GetEvaluationExpectationRequest, dict]] = None,
            *,
            name: Optional[str] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.get_evaluation_expectation]
    ...
    def create_evaluation_expectation(self,
            request: Optional[Union[evaluation_service.CreateEvaluationExpectationRequest, dict]] = None,
            *,
            parent: Optional[str] = None,
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, evaluation_service.CreateEvaluationExpectationRequest):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.create_evaluation_expectation]
    ...
    def update_evaluation_expectation(self,
            request: Optional[Union[evaluation_service.UpdateEvaluationExpectationRequest, dict]] = None,
            *,
            evaluation_expectation: Optional[evaluation.EvaluationExpectation] = None,
            update_mask: Optional[field_mask_pb2.FieldMask] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, evaluation_service.UpdateEvaluationExpectationRequest):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.update_evaluation_expectation]
    ...
    def delete_evaluation_expectation(self,
            request: Optional[Union[evaluation_service.DeleteEvaluationExpectationRequest, dict]] = None,
            *,
            name: Optional[str] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, evaluation_service.DeleteEvaluationExpectationRequest):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.delete_evaluation_expectation]
    ...
    def create_scheduled_evaluation_run(self,
            request: Optional[Union[evaluation_service.CreateScheduledEvaluationRunRequest, dict]] = None,
            *,
            parent: Optional[str] = None,
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        flattened_params = [parent, scheduled_evaluation_run, scheduled_evaluation_run_id]
        has_flattened_params = len([param for param in flattened_params if param is not None]) > 0
        if request is not None and has_flattened_params:
            raise ValueError('If the `request` argument is set, then none of '
                             'the individual field arguments should be set.')
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, evaluation_service.CreateScheduledEvaluationRunRequest):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.create_scheduled_evaluation_run]
    ...
    def get_scheduled_evaluation_run(self,
            request: Optional[Union[evaluation_service.GetScheduledEvaluationRunRequest, dict]] = None,
            *,
            name: Optional[str] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.get_scheduled_evaluation_run]
    ...
    def list_scheduled_evaluation_runs(self,
            request: Optional[Union[evaluation_service.ListScheduledEvaluationRunsRequest, dict]] = None,
            *,
            parent: Optional[str] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, evaluation_service.ListScheduledEvaluationRunsRequest):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.list_scheduled_evaluation_runs]
    ...
    def update_scheduled_evaluation_run(self,
            request: Optional[Union[evaluation_service.UpdateScheduledEvaluationRunRequest, dict]] = None,
            *,
            scheduled_evaluation_run: Optional[evaluation.ScheduledEvaluationRun] = None,
            update_mask: Optional[field_mask_pb2.FieldMask] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, evaluation_service.UpdateScheduledEvaluationRunRequest):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.update_scheduled_evaluation_run]

        # Certain fields should be provided within the metadata header;
        # add these here.
        metadata = tuple(metadata) + (
            gapic_v1.routing_header.to_grpc_metadata((
                ("scheduled_evaluation_run.name", request.scheduled_evaluation_run.name),
            )),
        )
    ...
    def delete_scheduled_evaluation_run(self,
            request: Optional[Union[evaluation_service.DeleteScheduledEvaluationRunRequest, dict]] = None,
            *,
            name: Optional[str] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, evaluation_service.DeleteScheduledEvaluationRunRequest):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.delete_scheduled_evaluation_run]
    ...
    def test_persona_voice(self,
            request: Optional[Union[evaluation_service.TestPersonaVoiceRequest, dict]] = None,
            *,
            app: Optional[str] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
