...
from google.cloud.ces_v1beta.types import bigquery_export
...
class App(proto.Message):
    ...
    predefined_variable_declarations: MutableSequence[VariableDeclaration] = proto.RepeatedField(
        proto.MESSAGE,
        number=28,
        message=VariableDeclaration,
    )
...
class EvaluationMetricsThresholds(proto.Message):
    ...
    golden_evaluation_metrics_thresholds: GoldenEvaluationMetricsThresholds = proto.Field(
        proto.MESSAGE,
        number=1,
...
class EvaluationPersona(proto.Message):
    ...
    class SpeechConfig(proto.Message):
        ...
        environment: 'EvaluationPersona.SpeechConfig.BackgroundEnvironment' = proto.Field(
            proto.ENUM,
            number=2,
