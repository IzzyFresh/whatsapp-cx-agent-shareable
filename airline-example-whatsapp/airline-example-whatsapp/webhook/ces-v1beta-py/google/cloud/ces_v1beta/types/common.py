...
class TriggerAction(proto.Message):
    ...
    Attributes:
        respond_immediately (google.cloud.ces_v1beta.types.TriggerAction.RespondImmediately):
            Optional. Immediately respond with a
            preconfigured response.

            This field is a member of `oneof`_ ``action``.
        transfer_agent (google.cloud.ces_v1beta.types.TriggerAction.TransferAgent):
            Optional. Transfer the conversation to a
            different agent.

            This field is a member of `oneof`_ ``action``.
        generative_answer (google.cloud.ces_v1beta.types.TriggerAction.GenerativeAnswer):
    ...
    class RespondImmediately(proto.Message):
        ...
        Attributes:
            responses (MutableSequence[google.cloud.ces_v1beta.types.TriggerAction.Response]):
...
class TlsConfig(proto.Message):
    ...
    Attributes:
        ca_certs (MutableSequence[google.cloud.ces_v1beta.types.TlsConfig.CaCert]):
...
class ChannelProfile(proto.Message):
    ...
    class PersonaProperty(proto.Message):
        ...
        Attributes:
            persona (google.cloud.ces_v1beta.types.ChannelProfile.PersonaProperty.Persona):
...
class Span(proto.Message):
    ...
    Attributes:
        ...
        attributes (google.protobuf.struct_pb2.Struct):
            ...
            with the span.
        child_spans (MutableSequence[google.cloud.ces_v1beta.types.Span]):
