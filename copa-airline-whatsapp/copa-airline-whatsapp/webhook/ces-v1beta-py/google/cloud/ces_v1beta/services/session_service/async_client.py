...
from .client import SessionServiceClient
...
class SessionServiceAsyncClient:
    """Session service provides APIs for interacting with CES
    agents.
    """

    _client: SessionServiceClient

    # Copy defaults from the synchronous client for use here.
    # Note: DEFAULT_ENDPOINT is deprecated. Use _DEFAULT_ENDPOINT_TEMPLATE instead.
    DEFAULT_ENDPOINT = SessionServiceClient.DEFAULT_ENDPOINT
    DEFAULT_MTLS_ENDPOINT = SessionServiceClient.DEFAULT_MTLS_ENDPOINT
    ...
    agent_path = staticmethod(SessionServiceClient.agent_path)
    parse_agent_path = staticmethod(SessionServiceClient.parse_agent_path)
    ...
    tool_path = staticmethod(SessionServiceClient.tool_path)
    parse_tool_path = staticmethod(SessionServiceClient.parse_tool_path)
    toolset_path = staticmethod(SessionServiceClient.toolset_path)
    parse_toolset_path = staticmethod(SessionServiceClient.parse_toolset_path)
    ...
    def get_mtls_endpoint_and_cert_source(cls, client_options: Optional[ClientOptions] = None):
        ...
        """
        return SessionServiceClient.get_mtls_endpoint_and_cert_source(client_options)  # type: ignore
    ...
    def transport(self) -> SessionServiceTransport:
        ...
        Returns:
            SessionServiceTransport: The transport used by the client instance.
        """
    ...
    get_transport_class = SessionServiceClient.get_transport_class
    ...
    def __init__(self, *,
        ...
        if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(std_logging.DEBUG):  # pragma: NO COVER
            _LOGGER.debug(
                "Created client `google.cloud.ces_v1beta.SessionServiceAsyncClient`.",
                extra = {
    ...
    async def run_session(self,
        ...
        .. code-block:: python
            ...
            async def sample_run_session():
                ...
                # Make the request
                response = await client.run_session(request=request)
        ...
        rpc = self._client._transport._wrapped_methods[self._client._transport.run_session]
    ...
    def bidi_run_session(self,
            requests: Optional[AsyncIterator[session_service.BidiSessionClientMessage]] = None,
            *,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
            metadata: Sequence[Tuple[str, Union[str, bytes]]] = (),
            ) -> Awaitable[AsyncIterable[session_service.BidiSessionServerMessage]]:
        ...
        .. code-block:: python
            ...
            async def sample_bidi_run_session():
                # Create a client
                client = ces_v1beta.SessionServiceAsyncClient()
                ...
                # Make the request
                stream = await client.bidi_run_session(requests=request_generator())
        ...
        Args:
            requests (AsyncIterator[`google.cloud.ces_v1beta.types.BidiSessionClientMessage`]):
        ...
        Returns:
            AsyncIterable[google.cloud.ces_v1beta.types.BidiSessionServerMessage]:
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.bidi_run_session]
    ...
    async def __aenter__(self) -> "SessionServiceAsyncClient":
        return self
