...
class ListEvaluationDatasetsAsyncPager:
    ...
    """
    def __init__(self,
            method: Callable[..., Awaitable[evaluation_service.ListEvaluationDatasetsResponse]],
            request: evaluation_service.ListEvaluationDatasetsRequest,
            response: evaluation_service.ListEvaluationDatasetsResponse,
            *,
            retry: OptionalAsyncRetry = gapic_v1.method.DEFAULT,
    ...
    @property
    async def pages(self) -> AsyncIterator[evaluation_service.ListEvaluationDatasetsResponse]:
        yield self._response
        while self._response.next_page_token:
            self._request.page_token = self._response.next_page_token
            self._response = await self._method(self._request, retry=self._retry, timeout=self._timeout, metadata=self._metadata)
...
class ListEvaluationRunsAsyncPager:
    ...
    @property
    async def pages(self) -> AsyncIterator[evaluation_service.ListEvaluationRunsResponse]:
        yield self._response
        while self._response.next_page_token:
            self._request.page_token = self._response.next_page_token
            self._response = await self._method(self._request, retry=self._retry, timeout=self._timeout, metadata=self._metadata)
...
class ListEvaluationExpectationsAsyncPager:
    ...
    """
    def __init__(self,
            method: Callable[..., Awaitable[evaluation_service.ListEvaluationExpectationsResponse]],
            request: evaluation_service.ListEvaluationExpectationsRequest,
            response: evaluation_service.ListEvaluationExpectationsResponse,
            *,
            retry: OptionalAsyncRetry = gapic_v1.method.DEFAULT,
    ...
    @property
    async def pages(self) -> AsyncIterator[evaluation_service.ListEvaluationExpectationsResponse]:
        yield self._response
        while self._response.next_page_token:
            self._request.page_token = self._response.next_page_token
            self._response = await self._method(self._request, retry=self._retry, timeout=self._timeout, metadata=self._metadata)
...
class ListScheduledEvaluationRunsAsyncPager:
    ...
    """
    def __init__(self,
            method: Callable[..., Awaitable[evaluation_service.ListScheduledEvaluationRunsResponse]],
            request: evaluation_service.ListScheduledEvaluationRunsRequest,
            response: evaluation_service.ListScheduledEvaluationRunsResponse,
            *,
            retry: OptionalAsyncRetry = gapic_v1.method.DEFAULT,
    ...
    @property
    async def pages(self) -> AsyncIterator[evaluation_service.ListScheduledEvaluationRunsResponse]:
        yield self._response
        while self._response.next_page_token:
            self._request.page_token = self._response.next_page_token
            self._response = await self._method(self._request, retry=self._retry, timeout=self._timeout, metadata=self._metadata)
