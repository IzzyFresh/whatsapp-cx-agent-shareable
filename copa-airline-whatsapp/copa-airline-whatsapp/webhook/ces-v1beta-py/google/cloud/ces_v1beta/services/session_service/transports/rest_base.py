...
class _BaseSessionServiceRestTransport(SessionServiceTransport):
    ...
    class _BaseBidiRunSession:
        def __hash__(self):  # pragma: NO COVER
            return NotImplementedError("__hash__ must be implemented.")

    class _BaseRunSession:
        def __hash__(self):  # pragma: NO COVER
            return NotImplementedError("__hash__ must be implemented.")
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [{
                'method': 'post',
                'uri': '/v1beta/{config.session=projects/*/locations/*/apps/*/sessions/*}:runSession',
                'body': '*',
            },
            ]
            return http_options
        ...
        def _get_transcoded_request(http_options, request):
            pb_request = session_service.RunSessionRequest.pb(request)
        ...
        def _get_query_params_json(transcoded_request):
            ...
            query_params.update(_BaseSessionServiceRestTransport._BaseRunSession._get_unset_required_fields(query_params))
