...
class AgentServiceGrpcAsyncIOTransport(AgentServiceTransport):
    """gRPC AsyncIO backend transport for AgentService.
    ...
    def list_apps(self) -> Callable[
            ...
            Awaitable[agent_service.ListAppsResponse]]:
    ...
    def batch_delete_conversations(self) -> Callable[
        ...
        if 'batch_delete_conversations' not in self._stubs:
            self._stubs['batch_delete_conversations'] = self._logged_channel.unary_unary(
    ...
    def list_guardrails(self) -> Callable[
        ...
        Returns:
            Callable[[~.ListGuardrailsRequest],
                    Awaitable[~.ListGuardrailsResponse]]:
                A function that, when called, will call the underlying RPC
                on the server.
        """
        # Generate a "stub function" on-the-fly which will actually make
    ...
    def create_guardrail(self) -> Callable[
            ...
            Awaitable[gcc_guardrail.Guardrail]]:
    ...
    def create_deployment(self) -> Callable[
            ...
            Awaitable[gcc_deployment.Deployment]]:
    ...
    def list_toolsets(self) -> Callable[
        ...
        Returns:
            Callable[[~.ListToolsetsRequest],
                    Awaitable[~.ListToolsetsResponse]]:
                A function that, when called, will call the underlying RPC
                on the server.
        """
        # Generate a "stub function" on-the-fly which will actually make
    ...
    def list_app_versions(self) -> Callable[
        ...
        Returns:
            Callable[[~.ListAppVersionsRequest],
                    Awaitable[~.ListAppVersionsResponse]]:
                A function that, when called, will call the underlying RPC
                on the server.
        """
        # Generate a "stub function" on-the-fly which will actually make
    ...
    def get_app_version(self) -> Callable[
            ...
            Awaitable[app_version.AppVersion]]:
    ...
    def create_app_version(self) -> Callable[
            ...
            Awaitable[gcc_app_version.AppVersion]]:
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.list_apps: self._wrap_method(
                self.list_apps,
                default_timeout=None,
                client_info=client_info,
            ),
            self.get_app: self._wrap_method(
                self.get_app,
                default_timeout=None,
                client_info=client_info,
            ),
            self.create_app: self._wrap_method(
                self.create_app,
                default_timeout=None,
                client_info=client_info,
            ),
            self.update_app: self._wrap_method(
                self.update_app,
                default_timeout=None,
                client_info=client_info,
            ),
            self.delete_app: self._wrap_method(
                self.delete_app,
                default_timeout=None,
                client_info=client_info,
            ),
            self.export_app: self._wrap_method(
                self.export_app,
                default_timeout=None,
                client_info=client_info,
            ),
            ...
            self.batch_delete_conversations: self._wrap_method(
            ...
            self.list_guardrails: self._wrap_method(
                self.list_guardrails,
                default_timeout=None,
                client_info=client_info,
            ),
            self.get_guardrail: self._wrap_method(
                self.get_guardrail,
                default_timeout=None,
                client_info=client_info,
            ),
            self.create_guardrail: self._wrap_method(
                self.create_guardrail,
                default_timeout=None,
                client_info=client_info,
            ),
            self.update_guardrail: self._wrap_method(
                self.update_guardrail,
                default_timeout=None,
                client_info=client_info,
            ),
            self.delete_guardrail: self._wrap_method(
            ...
            self.list_toolsets: self._wrap_method(
                self.list_toolsets,
                default_timeout=None,
                client_info=client_info,
            ),
            self.get_toolset: self._wrap_method(
                self.get_toolset,
                default_timeout=None,
                client_info=client_info,
            ),
            self.create_toolset: self._wrap_method(
                self.create_toolset,
                default_timeout=None,
                client_info=client_info,
            ),
            self.update_toolset: self._wrap_method(
                self.update_toolset,
                default_timeout=None,
                client_info=client_info,
            ),
            self.delete_toolset: self._wrap_method(
                self.delete_toolset,
                default_timeout=None,
                client_info=client_info,
            ),
            self.list_app_versions: self._wrap_method(
                self.list_app_versions,
                default_timeout=None,
                client_info=client_info,
            ),
            self.get_app_version: self._wrap_method(
                self.get_app_version,
                default_timeout=None,
                client_info=client_info,
            ),
            self.create_app_version: self._wrap_method(
                self.create_app_version,
                default_timeout=None,
                client_info=client_info,
            ),
            self.delete_app_version: self._wrap_method(
