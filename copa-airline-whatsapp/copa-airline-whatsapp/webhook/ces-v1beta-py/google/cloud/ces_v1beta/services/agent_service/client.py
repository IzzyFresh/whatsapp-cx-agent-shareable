...
class AgentServiceClient(metaclass=AgentServiceClientMeta):
    ...
    @staticmethod
    def deidentify_template_path(organization: str,location: str,deidentify_template: str,) -> str:
        """Returns a fully-qualified deidentify_template string."""
        return "organizations/{organization}/locations/{location}/deidentifyTemplates/{deidentify_template}".format(organization=organization, location=location, deidentify_template=deidentify_template, )
    ...
    @staticmethod
    def deployment_path(project: str,location: str,app: str,deployment: str,) -> str:
        """Returns a fully-qualified deployment string."""
        return "projects/{project}/locations/{location}/apps/{app}/deployments/{deployment}".format(project=project, location=location, app=app, deployment=deployment, )

    @staticmethod
    def parse_deployment_path(path: str) -> Dict[str,str]:
        """Parses a deployment path into its component segments."""
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/apps/(?P<app>.+?)/deployments/(?P<deployment>.+?)$", path)
        return m.groupdict() if m else {}

    @staticmethod
    def dialogflow_agent_path(project: str,location: str,agent: str,) -> str:
    ...
    @staticmethod
    def example_path(project: str,location: str,app: str,example: str,) -> str:
        """Returns a fully-qualified example string."""
        return "projects/{project}/locations/{location}/apps/{app}/examples/{example}".format(project=project, location=location, app=app, example=example, )

    @staticmethod
    def parse_example_path(path: str) -> Dict[str,str]:
        """Parses a example path into its component segments."""
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/apps/(?P<app>.+?)/examples/(?P<example>.+?)$", path)
        return m.groupdict() if m else {}

    @staticmethod
    def guardrail_path(project: str,location: str,app: str,guardrail: str,) -> str:
        """Returns a fully-qualified guardrail string."""
        return "projects/{project}/locations/{location}/apps/{app}/guardrails/{guardrail}".format(project=project, location=location, app=app, guardrail=guardrail, )

    @staticmethod
    def parse_guardrail_path(path: str) -> Dict[str,str]:
        """Parses a guardrail path into its component segments."""
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/apps/(?P<app>.+?)/guardrails/(?P<guardrail>.+?)$", path)
        return m.groupdict() if m else {}

    @staticmethod
    def inspect_template_path(organization: str,location: str,inspect_template: str,) -> str:
        """Returns a fully-qualified inspect_template string."""
        return "organizations/{organization}/locations/{location}/inspectTemplates/{inspect_template}".format(organization=organization, location=location, inspect_template=inspect_template, )
    ...
    def _get_api_endpoint(api_override, client_cert_source, universe_domain, use_mtls_endpoint):
        ...
        if api_override is not None:
            ...
            api_endpoint = AgentServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=universe_domain)
        return api_endpoint
    ...
    def __init__(self, *,
            ...
            transport: Optional[Union[str, AgentServiceTransport, Callable[..., AgentServiceTransport]]] = None,
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = AgentServiceClient._read_environment_variables()
        self._client_cert_source = AgentServiceClient._get_client_cert_source(self._client_options.client_cert_source, self._use_client_cert)
        self._universe_domain = AgentServiceClient._get_universe_domain(universe_domain_opt, self._universe_domain_env)
        ...
        if not transport_provided:
            ...
            transport_init: Union[Type[AgentServiceTransport], Callable[..., AgentServiceTransport]] = (
    ...
    def batch_delete_conversations(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.batch_delete_conversations]
