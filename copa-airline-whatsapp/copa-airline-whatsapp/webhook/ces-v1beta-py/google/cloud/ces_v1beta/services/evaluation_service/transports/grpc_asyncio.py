...
class EvaluationServiceGrpcAsyncIOTransport(EvaluationServiceTransport):
    ...
    def list_evaluation_expectations(self) -> Callable[
        ...
        if 'list_evaluation_expectations' not in self._stubs:
            self._stubs['list_evaluation_expectations'] = self._logged_channel.unary_unary(
    ...
    def get_evaluation_expectation(self) -> Callable[
        ...
        if 'get_evaluation_expectation' not in self._stubs:
            self._stubs['get_evaluation_expectation'] = self._logged_channel.unary_unary(
    ...
    def create_evaluation_expectation(self) -> Callable[
        ...
        if 'create_evaluation_expectation' not in self._stubs:
            self._stubs['create_evaluation_expectation'] = self._logged_channel.unary_unary(
    ...
    def update_evaluation_expectation(self) -> Callable[
        ...
        if 'update_evaluation_expectation' not in self._stubs:
            self._stubs['update_evaluation_expectation'] = self._logged_channel.unary_unary(
    ...
    def delete_evaluation_expectation(self) -> Callable[
        ...
        if 'delete_evaluation_expectation' not in self._stubs:
            self._stubs['delete_evaluation_expectation'] = self._logged_channel.unary_unary(
    ...
    def create_scheduled_evaluation_run(self) -> Callable[
        ...
        if 'create_scheduled_evaluation_run' not in self._stubs:
            self._stubs['create_scheduled_evaluation_run'] = self._logged_channel.unary_unary(
    ...
    def get_scheduled_evaluation_run(self) -> Callable[
        ...
        if 'get_scheduled_evaluation_run' not in self._stubs:
            self._stubs['get_scheduled_evaluation_run'] = self._logged_channel.unary_unary(
    ...
    def list_scheduled_evaluation_runs(self) -> Callable[
        ...
        if 'list_scheduled_evaluation_runs' not in self._stubs:
            self._stubs['list_scheduled_evaluation_runs'] = self._logged_channel.unary_unary(
    ...
    def update_scheduled_evaluation_run(self) -> Callable[
        ...
        if 'update_scheduled_evaluation_run' not in self._stubs:
            self._stubs['update_scheduled_evaluation_run'] = self._logged_channel.unary_unary(
    ...
    def delete_scheduled_evaluation_run(self) -> Callable[
        ...
        if 'delete_scheduled_evaluation_run' not in self._stubs:
            self._stubs['delete_scheduled_evaluation_run'] = self._logged_channel.unary_unary(
