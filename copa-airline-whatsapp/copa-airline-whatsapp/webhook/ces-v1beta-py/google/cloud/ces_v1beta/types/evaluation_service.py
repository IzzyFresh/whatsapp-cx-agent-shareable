...
class ListEvaluationsRequest(proto.Message):
    ...
    Attributes:
        ...
        filter (str):
            ...
            See https://google.aip.dev/160 for more details. Currently
            supports filtering by the following fields:

            - evaluation_datasets, using the evaluation dataset ID in
              the format evaluation_datasets:evaluation_dataset_id.
...
class ListEvaluationResultsResponse(proto.Message):
    ...
    evaluation_results: MutableSequence[gcc_evaluation.EvaluationResult] = proto.RepeatedField(
        proto.MESSAGE,
        number=1,
...
class ListEvaluationDatasetsResponse(proto.Message):
    ...
    evaluation_datasets: MutableSequence[gcc_evaluation.EvaluationDataset] = proto.RepeatedField(
        proto.MESSAGE,
        number=1,
        message=gcc_evaluation.EvaluationDataset,
    )
...
class ListEvaluationRunsResponse(proto.Message):
    ...
    evaluation_runs: MutableSequence[gcc_evaluation.EvaluationRun] = proto.RepeatedField(
        proto.MESSAGE,
        number=1,
...
class ListScheduledEvaluationRunsResponse(proto.Message):
    ...
    scheduled_evaluation_runs: MutableSequence[gcc_evaluation.ScheduledEvaluationRun] = proto.RepeatedField(
        proto.MESSAGE,
        number=1,
        message=gcc_evaluation.ScheduledEvaluationRun,
    )
...
class ListEvaluationExpectationsResponse(proto.Message):
    ...
    evaluation_expectations: MutableSequence[gcc_evaluation.EvaluationExpectation] = proto.RepeatedField(
        proto.MESSAGE,
        number=1,
        message=gcc_evaluation.EvaluationExpectation,
    )
