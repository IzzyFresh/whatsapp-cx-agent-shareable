...
class Guardrail(proto.Message):
    ...
    class LlmPromptSecurity(proto.Message):
        ...
        Attributes:
            ...
            custom_policy (google.cloud.ces_v1beta.types.Guardrail.LlmPolicy):
                ...
                This field is a member of `oneof`_ ``security_config``.
            fail_open (bool):
                Optional. If true, the guardrail will not trigger if it
                receives any errors from the LLM. By default, the guardrail
                will trigger if it receives any errors from the LLM. This
                flag will be ignored if the guardrail is configured to use a
                custom policy, and will use the fail_open setting in the
        ...
        default_settings: 'Guardrail.LlmPromptSecurity.DefaultSecuritySettings' = proto.Field(
            proto.MESSAGE,
            number=1,
    ...
    class ModelSafety(proto.Message):
        ...
        safety_settings: MutableSequence['Guardrail.ModelSafety.SafetySetting'] = proto.RepeatedField(
            proto.MESSAGE,
            number=1,
