...
class Omnichannel(proto.Message):
    ...
    Attributes:
        ...
        etag (str):
            ...
            operation.
        integration_config (google.cloud.ces_v1beta.types.OmnichannelIntegrationConfig):
...
class OmnichannelIntegrationConfig(proto.Message):
    ...
    class ChannelConfig(proto.Message):
        ...
        Attributes:
            whatsapp_config (google.cloud.ces_v1beta.types.OmnichannelIntegrationConfig.WhatsappConfig):
                WhatsApp config.
    ...
    class SubscriberConfig(proto.Message):
        ...
        Attributes:
            ces_app_config (google.cloud.ces_v1beta.types.OmnichannelIntegrationConfig.CesAppConfig):
                Ces app config.
