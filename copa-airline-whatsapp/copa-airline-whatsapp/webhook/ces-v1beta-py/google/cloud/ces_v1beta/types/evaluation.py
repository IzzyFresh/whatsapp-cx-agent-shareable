...
class AggregatedMetrics(proto.Message):
    ...
    class MetricsByAppVersion(proto.Message):
        ...
        tool_metrics: MutableSequence['AggregatedMetrics.ToolMetrics'] = proto.RepeatedField(
            proto.MESSAGE,
            number=2,
            message='AggregatedMetrics.ToolMetrics',
        )
        semantic_similarity_metrics: MutableSequence['AggregatedMetrics.SemanticSimilarityMetrics'] = proto.RepeatedField(
            proto.MESSAGE,
            number=3,
            message='AggregatedMetrics.SemanticSimilarityMetrics',
        )
        hallucination_metrics: MutableSequence['AggregatedMetrics.HallucinationMetrics'] = proto.RepeatedField(
            proto.MESSAGE,
            number=5,
            message='AggregatedMetrics.HallucinationMetrics',
        )
        tool_call_latency_metrics: MutableSequence['AggregatedMetrics.ToolCallLatencyMetrics'] = proto.RepeatedField(
            proto.MESSAGE,
            number=6,
            message='AggregatedMetrics.ToolCallLatencyMetrics',
        )
        turn_latency_metrics: MutableSequence['AggregatedMetrics.TurnLatencyMetrics'] = proto.RepeatedField(
            proto.MESSAGE,
            number=7,
        ...
        metrics_by_turn: MutableSequence['AggregatedMetrics.MetricsByTurn'] = proto.RepeatedField(
            proto.MESSAGE,
            number=4,
...
class Evaluation(proto.Message):
    ...
    class ScenarioExpectation(proto.Message):
        ...
        tool_expectation: 'Evaluation.ScenarioExpectation.ToolExpectation' = proto.Field(
            proto.MESSAGE,
            number=1,
            oneof='expectation',
    ...
    class Scenario(proto.Message):
        ...
        user_facts: MutableSequence['Evaluation.Scenario.UserFact'] = proto.RepeatedField(
            proto.MESSAGE,
            number=4,
        ...
        scenario_expectations: MutableSequence['Evaluation.ScenarioExpectation'] = proto.RepeatedField(
            proto.MESSAGE,
            number=3,
        ...
        task_completion_behavior: 'Evaluation.Scenario.TaskCompletionBehavior' = proto.Field(
            proto.ENUM,
            number=7,
...
class EvaluationResult(proto.Message):
    ...
    class GoldenExpectationOutcome(proto.Message):
        ...
        semantic_similarity_result: 'EvaluationResult.SemanticSimilarityResult' = proto.Field(
            proto.MESSAGE,
            number=7,
    ...
    class GoldenResult(proto.Message):
        ...
        class TurnReplayResult(proto.Message):
            ...
            expectation_outcome: MutableSequence['EvaluationResult.GoldenExpectationOutcome'] = proto.RepeatedField(
                proto.MESSAGE,
                number=2,
            ...
            tool_call_latencies: MutableSequence['EvaluationResult.ToolCallLatency'] = proto.RepeatedField(
                proto.MESSAGE,
                number=7,
        ...
        turn_replay_results: MutableSequence['EvaluationResult.GoldenResult.TurnReplayResult'] = proto.RepeatedField(
            proto.MESSAGE,
            number=1,
    ...
    class ScenarioResult(proto.Message):
        ...
        expectation_outcomes: MutableSequence['EvaluationResult.ScenarioExpectationOutcome'] = proto.RepeatedField(
            proto.MESSAGE,
            number=2,
            message='EvaluationResult.ScenarioExpectationOutcome',
        )
        rubric_outcomes: MutableSequence['EvaluationResult.ScenarioRubricOutcome'] = proto.RepeatedField(
            proto.MESSAGE,
            number=3,
            message='EvaluationResult.ScenarioRubricOutcome',
        )
        hallucination_result: MutableSequence['EvaluationResult.HallucinationResult'] = proto.RepeatedField(
            proto.MESSAGE,
            number=4,
            message='EvaluationResult.HallucinationResult',
        )
        ...
        user_goal_satisfaction_result: 'EvaluationResult.UserGoalSatisfactionResult' = proto.Field(
            proto.MESSAGE,
            number=7,
    ...
    golden_run_method: 'GoldenRunMethod' = proto.Field(
        proto.ENUM,
        number=19,
...
class EvaluationRun(proto.Message):
    ...
    evaluation_run_summaries: MutableMapping[str, EvaluationRunSummary] = proto.MapField(
        proto.STRING,
        proto.MESSAGE,
        number=15,
...
class OptimizationConfig(proto.Message):
    ...
    assistant_session_name: str = proto.Field(
        proto.STRING,
        number=2,
    )
