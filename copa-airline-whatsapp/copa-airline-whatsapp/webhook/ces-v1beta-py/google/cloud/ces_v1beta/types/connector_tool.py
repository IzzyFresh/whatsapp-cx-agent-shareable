...
from google.cloud.ces_v1beta.types import auth
...
class Action(proto.Message):
    ...
    Attributes:
        ...
        entity_operation (google.cloud.ces_v1beta.types.Action.EntityOperation):
    ...
    class EntityOperation(proto.Message):
        ...
        Attributes:
            ...
            operation (google.cloud.ces_v1beta.types.Action.EntityOperation.OperationType):
